...
bulk.density.plot.S11 <- site_filtered_data %>%
  ...
  ylim(1.0, 2.4)+
  theme_bw()+
  labs(title="Single Site - Site 11",
    x = "Species",
    y = "Bulk Density g/cm2"
  )
...
bulk.density.plot.S12 <- site_filtered_data %>%
  ...
  ylim(1.0, 2.4)+
  theme_bw()+
  labs(title="Single Site - Site 12",
    x = "Species",
    y = "Bulk Density g/cm2"
  )
...
bulk.density.plot.S18 <- site_filtered_data %>%
  ...
  ylim(1.0, 2.4)+
  theme_bw()+
  labs(title="Single Site - Site 18",
    x = "Species",
    y = "Bulk Density g/cm2"
  )
