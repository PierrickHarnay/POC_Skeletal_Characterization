...
size.s2.bulk <- ggplot(site_filtered_data, aes(x = Species, y = Bulk.Density, fill = Size.Class)) +
  ...
  theme_classic() +
  labs(
    title = "Bulk Density per Species by Custom Size Class (Site S2)",
    y = "Bulk Density (g/cm³)",
    x = "Species",
    fill = "Size Class"
  )
...
size.s2.bulk <- ggplot (site_filtered_data, aes(x = Species, y = Bulk.Density, fill = Size.Class)) +
  ...
  theme(
    axis.text.x = element_text(
      color = species_colors[levels(site_filtered_data$Species)],
      angle = 45, hjust = 1  # Optional: tilt for readability
    )
  )
...
# Step 3: Plot bulk density per species, colored by custom size class
size.s3.bulk <- ggplot(site_filtered_data, aes(x = Species, y = Bulk.Density, fill = Size.Class)) +
  geom_boxplot(alpha = 0.7, outlier.shape = NA) +
  geom_jitter(position = position_jitterdodge(jitter.width = 0.2, dodge.width = 0.75), alpha = 0.3, size = 1) +
  scale_fill_manual(values = c("0-2cm" = "#66c2a5", 
                               ">2cm-5cm" = "#fc8d62", 
...
# Step 3: Plot bulk density per species, colored by custom size class
size.s4.bulk <- ggplot(site_filtered_data, aes(x = Species, y = Bulk.Density, fill = Size.Class)) +
  geom_boxplot(alpha = 0.7, outlier.shape = NA) +
  geom_jitter(position = position_jitterdodge(jitter.width = 0.2, dodge.width = 0.75), alpha = 0.3, size = 1) +
  scale_fill_manual(values = c("0-2cm" = "#66c2a5", 
                               ">2cm-5cm" = "#fc8d62", 
  ...
  theme_classic() +
  labs(
    title = "Bulk Density per Species by Custom Size Class (Site S4)",
    y = "Bulk Density (g/cm³)",
    x = "Species",
    fill = "Size Class"
  )
...
# Step 3: Plot bulk density per species, colored by custom size class
size.s5.bulk <- ggplot(site_filtered_data, aes(x = Species, y = Bulk.Density, fill = Size.Class)) +
  geom_boxplot(alpha = 0.7, outlier.shape = NA) +
  geom_jitter(position = position_jitterdodge(jitter.width = 0.2, dodge.width = 0.75), alpha = 0.3, size = 1) +
  scale_fill_manual(values = c("0-2cm" = "#66c2a5", 
                               ">2cm-5cm" = "#fc8d62", 
...
# Step 3: Plot bulk density per species, colored by custom size class
size.s6.bulk <- ggplot(site_filtered_data, aes(x = Species, y = Bulk.Density, fill = Size.Class)) +
  geom_boxplot(alpha = 0.7, outlier.shape = NA) +
  geom_jitter(position = position_jitterdodge(jitter.width = 0.2, dodge.width = 0.75), alpha = 0.3, size = 1) +
  scale_fill_manual(values = c("0-2cm" = "#66c2a5", 
                               ">2cm-5cm" = "#fc8d62", 
  ...
  theme_classic() +
  labs(
    title = "Bulk Density per Species by Custom Size Class (Site S6)",
    y = "Bulk Density (g/cm³)",
    x = "Species",
    fill = "Size Class"
  )
...
# Step 3: Plot bulk density per species, colored by custom size class
size.s9.bulk <- ggplot(site_filtered_data, aes(x = Species, y = Bulk.Density, fill = Size.Class)) +
  geom_boxplot(alpha = 0.7, outlier.shape = NA) +
  geom_jitter(position = position_jitterdodge(jitter.width = 0.2, dodge.width = 0.75), alpha = 0.3, size = 1) +
  scale_fill_manual(values = c("0-2cm" = "#66c2a5", 
                               ">2cm-5cm" = "#fc8d62", 
  ...
  theme_classic() +
  labs(
    title = "Bulk Density per Species by Custom Size Class (Site S9)",
    y = "Bulk Density (g/cm³)",
    x = "Species",
    fill = "Size Class"
  )
...
# Step 3: Plot bulk density per species, colored by custom size class
size.s11.bulk <- ggplot(site_filtered_data, aes(x = Species, y = Bulk.Density, fill = Size.Class)) +
  geom_boxplot(alpha = 0.7, outlier.shape = NA) +
  geom_jitter(position = position_jitterdodge(jitter.width = 0.2, dodge.width = 0.75), alpha = 0.3, size = 1) +
  scale_fill_manual(values = c("0-2cm" = "#66c2a5", 
                               ">2cm-5cm" = "#fc8d62", 
  ...
  theme_classic() +
  labs(
    title = "Bulk Density per Species by Custom Size Class (Site S11)",
    y = "Bulk Density (g/cm³)",
    x = "Species",
    fill = "Size Class"
  )
...
ggsave("size.s11.bulk.pdf", plot = size.s11.bulk, width = 10, height = 6, dpi = 300)
size.s11.bulk
```
...
# Step 3: Plot bulk density per species, colored by custom size class
size.s12.bulk <-ggplot(site_filtered_data, aes(x = Species, y = Bulk.Density, fill = Size.Class)) +
  geom_boxplot(alpha = 0.7, outlier.shape = NA) +
  geom_jitter(position = position_jitterdodge(jitter.width = 0.2, dodge.width = 0.75), alpha = 0.3, size = 1) +
  scale_fill_manual(values = c("0-2cm" = "#66c2a5", 
                               ">2cm-5cm" = "#fc8d62", 
  ...
  theme_classic() +
  labs(
    title = "Bulk Density per Species by Custom Size Class (Site S12)",
    y = "Bulk Density (g/cm³)",
    x = "Species",
    fill = "Size Class"
  )
...
# Step 3: Plot bulk density per species, colored by custom size class
size.s14.bulk <- ggplot(site_filtered_data, aes(x = Species, y = Bulk.Density, fill = Size.Class)) +
  geom_boxplot(alpha = 0.7, outlier.shape = NA) +
  geom_jitter(position = position_jitterdodge(jitter.width = 0.2, dodge.width = 0.75), alpha = 0.3, size = 1) +
  scale_fill_manual(values = c("0-2cm" = "#66c2a5", 
                               ">2cm-5cm" = "#fc8d62", 
...
# Step 3: Plot bulk density per species, colored by custom size class
size.s15.bulk <- ggplot(site_filtered_data, aes(x = Species, y = Bulk.Density, fill = Size.Class)) +
  geom_boxplot(alpha = 0.7, outlier.shape = NA) +
  geom_jitter(position = position_jitterdodge(jitter.width = 0.2, dodge.width = 0.75), alpha = 0.3, size = 1) +
  scale_fill_manual(values = c("0-2cm" = "#66c2a5", 
                               ">2cm-5cm" = "#fc8d62", 
  ...
  theme_classic() +
  labs(
    title = "Bulk Density per Species by Custom Size Class (Site S15)",
    y = "Bulk Density (g/cm³)",
    x = "Species",
    fill = "Size Class"
  )
...
# Step 3: Plot bulk density per species, colored by custom size class
size.s18.bulk <- ggplot(site_filtered_data, aes(x = Species, y = Bulk.Density, fill = Size.Class)) +
  geom_boxplot(alpha = 0.7, outlier.shape = NA) +
  geom_jitter(position = position_jitterdodge(jitter.width = 0.2, dodge.width = 0.75), alpha = 0.3, size = 1) +
  scale_fill_manual(values = c("0-2cm" = "#66c2a5", 
                               ">2cm-5cm" = "#fc8d62", 
...
Plot all the graph in one place wiith the sizes! 
```{r}
